...
!(function(a, b) {
  ...
  (r.fn = r.prototype = {
    ...
    now: Date.now,
    support: o,
  }), typeof Symbol == 'function' && (r.fn[Symbol.iterator] = c[Symbol.iterator]), r.each(
              ...
              (
                ...
                ja((a) => {
                  ...
                  b.setAttribute(
                    'type',
                    'hidden',
                  ), a.appendChild(b).setAttribute('name', 'D'), a.querySelectorAll('[name=d]').length && q.push(`name${  K  }*[*^$|!~]?=`), a.querySelectorAll(':enabled').length !== 2 && q.push(':enabled', ':disabled'), (o.appendChild(a).disabled = !0), a.querySelectorAll(':disabled').length !== 2 && q.push(':enabled', ':disabled'), a.querySelectorAll('*,:x'), q.push(',.*:');
                })
              ),
  ...
  let aa = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
    ...
    da = function(a, b) {
      return (a = b || a), a.style.display === 'none' ||
        (a.style.display === '' &&
  ...
  function Ka(a, b, c) {
    for (var d, e = b ? r.filter(b, a) : a, f = 0; (d = e[f]) != null; f++)
      c || d.nodeType !== 1 || r.cleanData(na(d)), d.parentNode &&
        (
    ...
    function b() {
      if (i) {
        (i.style.cssText =
          ...
          ''), ra.appendChild(h);
        let b = a.getComputedStyle(i);
        (c = b.top !== '1%'), (g = b.marginLeft === '2px'), (e =
          b.width === '4px'), (i.style.marginRight = '50%'), (f =
          b.marginRight === '4px'), ra.removeChild(h), (i = null);
      }
    }
    var c,
      e,
  ...
  function Za(a, b, c, d, e) {
    ...
    for (
      ...
      c === 'margin' && (g += r.css(a, c + ca[f], !0, e)), d
        ? (
  ...
  (r.Animation = r.extend(kb, {
    ...
    return r.fx.off
      ...
      : typeof d.duration != 'number' &&
        (d.duration in r.fx.speeds
          ...
          : (d.duration = r.fx.speeds._default)), (d.queue != null &&
      d.queue !== !0) ||
    ...
    (a.type =
      'checkbox'), (o.checkOn = a.value !== ''), (o.optSelected = c.selected), (a = d.createElement('input')), (a.value = 't'), (a.type = 'radio'), (o.radioValue = a.value === 't');
  })();
  let lb,
  ...
  (o.cors =
    !!Sb &&
    'withCredentials' in Sb), (o.ajax = Sb = !!Sb), r.ajaxTransport((
    b,
  ) => {
    let c, d;
  ...
  r.ajaxSetup({
    ...
    return (a.innerHTML = '<form></form><form></form>'), a.childNodes.length ===
      2;
    ...
    r.fn[a] = function(d) {
      return T(
        ...
        (a, d, e) => {
          ...
          return r.isWindow(a)
            ? (f = a)
            : a.nodeType === 9 && (f = a.defaultView), void 0 === e
            ? f ? f[b] : a[d]
            : void (f
  ...
  }), (r.isArray = Array.isArray), (r.parseJSON = JSON.parse), (r.nodeName = B), typeof define ==
    'function' &&
    define.amd &&
    define('jquery', [], () => {
      return r;
