						...
						success: function(msg) {
							if (parseInt(msg, 0) !== 0) {
								...
								if (msg_split[0] === 'success') {
									...
									// $submit.removeAttr('disabled');
									$form.find('.submit-status').html('<span class="success"><i class="ion ion-ios-checkmark-outline"></i> ' + msg_split[1] + '</span>').fadeIn(300).delay(3000).fadeOut(300);
								} else {
									...
									// $submit.removeAttr('disabled');
									$form.find('.submit-status').html('<span class="error"><i class="ion ion-ios-close-outline"></i> ' + msg_split[1] + '</span>').fadeIn(300).delay(3000).fadeOut(300);
								}
							}
						}
					});
