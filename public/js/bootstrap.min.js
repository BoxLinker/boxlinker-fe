...
+(function(a) {
  ...
  (c.VERSION = '3.3.7'), (c.DEFAULTS = {
    ...
    let c = 'disabled',
      ...
      f = d.data();
    (b += 'Text'), f.resetText == null &&
      d.data('resetText', d[e]()), setTimeout(
      a.proxy(function() {
        d[e](
          f[b] == null ? this.options[b] : f[b],
        ), b == 'loadingText' ? ((this.isLoading = !0), d.addClass(c).attr(c, c).prop(c, !0)) : this.isLoading && ((this.isLoading = !1), d.removeClass(c).removeAttr(c).prop(c, !1));
      }, this),
      0,
    );
  ...
  var c = function(b, c) {
    (this.$element = a(b)), (this.$indicators = this.$element.find(
      ...
      .options.keyboard &&
      this.$element.on('keydown.bs.carousel', a.proxy(this.keydown, this)), this
      .options.pause == 'hover' &&
  ...
  (c.VERSION =
      ...
      (
        ...
        this.backdrop(() => {
          ...
          d.$element.parent().length ||
            d.$element.appendTo(d.$body), d.$element
            .show()
            .scrollTop(0), d.adjustDialog(), e &&
            d.$element[0].offsetWidth, d.$element.addClass(
            'in',
          ), d.enforceFocus();
    ...
    this.$element.hide(), this.backdrop(() => {
      a.$body.removeClass(
        'modal-open',
      ), a.resetAdjustments(), a.resetScrollbar(), a.$element.trigger(
        'hidden.bs.modal',
      );
    });
  ...
  function b(c, d) {
    ...
    )), (this.options = a.extend({}, b.DEFAULTS, d)), (this.selector = `${this
      .options.target ||
  ...
  (b.VERSION = '3.3.7'), (b.DEFAULTS = {
    ...
    let c = `${this.selector}[data-target="${b}"],${this
        .selector}[href="${b}"]`,
