  ...
  let S2 = (function() {
    ...
    S2.define('select2/utils', ['jquery'], function($) {
      ...
      Utils.escapeMarkup = function(markup) {
        ...
        return String(markup).replace(/[&<>"'\/\\]/g, (match) => {
    ...
    S2.define('select2/results', ['jquery', './utils'], function($, Utils) {
      ...
      Results.prototype.setClasses = function() {
        ...
        this.data.current((selected) => {
          let selectedIds = $.map(selected, (s) => {
            return s.id.toString();
          });

          let $options = self.$results.find(
            '.select2-results__option[aria-selected]',
          );
      ...
      Results.prototype.getHighlightedResults = function() {
        let $highlighted = this.$results.find(
    ...
    S2.define(
      ...
      function(SelectAdapter, Utils, $) {
        ...
        let $option = this.$element.find('option').filter((i, elm) => {
    ...
    S2.define('select2/data/tokenizer', ['jquery'], function($) {
      ...
      Tokenizer.prototype.query = function(decorated, params, callback) {
        ...
        function createAndSelect(data) {
          ...
          let $existingOptions = self.$element
            .find('option')
            .filter(function() {
              return $(this).val() === item.id;
            });
    ...
    S2.define('select2/dropdown/attachBody', ['jquery', '../utils'], function(
      ...
      AttachBody.prototype._positionDropdown = function() {
        ...
        let isCurrentlyAbove = this.$dropdown.hasClass(
          'select2-dropdown--above',
        );
        let isCurrentlyBelow = this.$dropdown.hasClass(
