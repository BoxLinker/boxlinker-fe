...
!(function(a) {
  ...
  (z = {
    ...
    return H === !1
      ? !1
      : '' === H ? a : H + a.charAt(0).toUpperCase() + a.substr(1);
  }), (E = G('transform')), (B = E !== !1), (A = function() {
    var a, b, d;
    return (a = c.createElement('div')), (b = a.style), (b.position =
      'absolute'), (b.width = '100px'), (b.height =
      '100px'), (b.overflow = t), (b.top = '-9999px'), c.body.appendChild(
      a,
    ), (d = a.offsetWidth - a.clientWidth), c.body.removeChild(a), d;
  }), (C = function() {
    var a, c, d;
    ...
    function j(d, f) {
      (this.el = d), (this.options = f), e || (e = A()), (this.$el = a(
        this.el,
      )), (this.doc = a(this.options.documentContext || c)), (this.win = a(
        this.options.windowContext || b,
      )), (this.body = this.doc.find(
        'body',
      ...
      ), (this.content = this.$content[0]), (this.previousPosition = 0), this
        .options.iOSNativeScrolling &&
      null != this.el.style.WebkitOverflowScrolling
        ? this.nativeScrolling()
        : this.generate(), this.createEvents(), this.addEvents(), this.reset();
    }
    return (j.prototype.preventScrolling = function(a, b) {
      ...
      var a, b;
      (a = this.content), (this.maxScrollTop =
        a.scrollHeight - a.clientHeight), (this.prevScrollTop =
        this.contentScrollTop || 0), (this.contentScrollTop = a.scrollTop), (b =
        this.contentScrollTop > this.previousPosition
          ? 'down'
          : this.contentScrollTop < this.previousPosition
            ? 'up'
            : 'same'), (this.previousPosition = this.contentScrollTop), 'same' !==
        b &&
      ...
      this.events = {
        down: (function(a) {
          return function(b) {
            return (a.isBeingDragged = !0), (a.offsetY =
              b.pageY - a.slider.offset().top), a.slider.is(b.target) ||
              (a.offsetY = 0), a.pane.addClass('active'), a.doc
              .bind(n, a.events[h])
        ...
        drag: (function(a) {
          return function(b) {
            return (a.sliderY =
              ...
              a.paneTop -
              (a.offsetY ||
                0.5 * a.sliderHeight)), a.scroll(), a.contentScrollTop >=
              a.maxScrollTop && a.prevScrollTop !== a.maxScrollTop
        ...
        up: (function(a) {
          return function(b) {
            return (a.isBeingDragged = !1), a.pane.removeClass(
              'active',
            ), a.doc
              .unbind(n, a.events[h])
        ...
        panedown: (function(a) {
          return function(b) {
            return (a.sliderY =
              ...
              0.5 * a.sliderHeight), a.scroll(), a.events.down(b), !1;
          };
        })(this),
        scroll: (function(a) {
          return function(b) {
          ...
          return function(b) {
            ...
            if (null != b)
              return (c =
                ...
                -b.detail ||
                (b.originalEvent && -b.originalEvent.detail)), c &&
                (a.sliderY += -c / 3), a.scroll(), !1;
          };
        })(this),
        enter: (function(a) {
          return function(b) {
      ...
      (a = this.events), this.win.unbind(s, a[s]), this.iOSNativeScrolling ||
        (this.slider.unbind(), this.pane.unbind()), this.$content.unbind(
        '' + t + ' ' + p + ' ' + f + ' ' + v,
        a[t],
      );
    }), (j.prototype.generate = function() {
      var a, c, d, f, g, h, i;
      return (f = this.options), (h = f.paneClass), (i = f.sliderClass), (a =
        f.contentClass), (g = this.$el.children('.' + h)).length ||
        g.children('.' + i).length ||
        this.$el.append(
          '<div class="' + h + '"><div class="' + i + '" /></div>',
        ), (this.pane = this.$el.children(
        '.' + h,
      )), (this.slider = this.pane.find('.' + i)), 0 === e && C()
        ? (
            (d = b
        ...
        : e &&
          ((c = { right: -e }), this.$el.addClass('has-scrollbar')), null !=
        c && this.$content.css(c), this;
    }), (j.prototype.restore = function() {
      (this.stopped = !1), this.iOSNativeScrolling ||
        this.pane.show(), this.addEvents();
      ...
      return y &&
        ...
        (
          y(this.scrollRAF),
          (this.scrollRAF = null)
        ), (this.stopped = !0), this.removeEvents(), this.iOSNativeScrolling ||
        this.pane.hide(), this;
    }), (j.prototype.destroy = function() {
      return this.stopped || this.stop(), !this.iOSNativeScrolling &&
        this.pane.length &&
        this.pane.remove(), d &&
        this.$content.height(''), this.$content.removeAttr(
        'tabindex',
...
!(function(a, b) {
  ...
  var d = (
    ...
    e = (function(a) {
      ...
      function e() {
        (f = c()), (a.fn.emulateTransitionEnd = d), h.supportsTransitionEnd() &&
  ...
  (function(a) {
    var b = 'metisMenu',
      ...
      m = (function() {
        function b(a, d) {
          c(this, b), (this._element = a), (this._config = this._getConfig(
            d,
          )), (this._transitioning = null), this.init();
        }
        return (b.prototype.init = function() {
          ...
          a(this._element)
            ...
            .addClass(this._config.collapseClass), a(this._element)
            .find(this._config.parentTrigger)
            .has(this._config.subMenu)
            ...
            .on(l.CLICK_DATA_API, function(c) {
              ...
              b._config.preventDefault &&
                c.preventDefault(), 'true' !== d.attr('aria-disabled') && (e.hasClass(b._config.activeClass) ? (d.attr('aria-expanded', !1), b._hide(g)) : (b._show(g), d.attr('aria-expanded', !0), b._config.toggle && f.attr('aria-expanded', !1)), b._config.onTransitionStart && b._config.onTransitionStart(c));
            });
          ...
          if (
            ...
            if ((d.trigger(f), !f.isDefaultPrevented())) {
              d
                ...
                .addClass(this._config.activeClass), this._config.toggle &&
                this._hide(
                  d
                    .parent(this._config.parentTrigger)
                    .siblings()
              ...
              var g = function() {
                d
                  ...
                  .height('')
                  .attr('aria-expanded', !0), c.setTransitioning(!1), d.trigger(
                  l.SHOWN,
                );
              };
          ...
          if (
            ...
            if ((d.trigger(f), !f.isDefaultPrevented())) {
              d
                .parent(this._config.parentTrigger)
                .removeClass(this._config.activeClass), d.height(d.height())[0]
                .offsetHeight, d
                .addClass(this._config.collapsingClass)
                .removeClass(this._config.collapseClass)
                .removeClass(
              ...
              var g = function() {
                c._transitioning &&
                  ...
                  c._config.onTransitionEnd(), c.setTransitioning(
                  !1,
                ), d.trigger(l.HIDDEN), d
                  .removeClass(c._config.collapsingClass)
          ...
          a.removeData(this._element, f), a(this._element)
            .find(this._config.parentTrigger)
            .has(this._config.subMenu)
            .children(this._config.triggerElement)
            .off(
    ...
    return (a.fn[b] = m._jQueryInterface), (a.fn[b].Constructor = m), (a.fn[
      b
    ].noConflict = function() {
...
!(function($, e) {
  ...
  (t.eventName = 'resizeEnd'), (t.delay = 250), (t.poll = function() {
    ...
    a.timeoutId &&
      e.clearTimeout(a.timeoutId), (a.timeoutId = e.setTimeout(function() {
...
!(function($) {
  ...
  $(document).ready(function() {
    ...
    $(document).on('nifty.ready', () => {
        let dropdownAnim = function(dropup, margin, opacity, block = false){
            let margin_prop = 'margin-top', styles = {};
    ...
    $('.dropdown').on('show.bs.dropdown', function(e) {
        ...
        ori_margin = parseInt(
          $dropdown.css(dropup ? 'margin-bottom' : 'margin-top'),
        );

      $dropdown
        .css(dropdownAnim(dropup, ori_margin - 15, 0))
        .animate(dropdownAnim(dropup, ori_margin, 1), 250, function() {
    ...
    // Add slidedown & fadeout animation to dropdown
      ...
      $dropdown
        .css(dropdownAnim(dropup, ori_margin, 1, true))
        .animate(dropdownAnim(dropup, ori_margin + 15, 0), 250, function() {
...
!(function($) {
    ...
    var megadropdown = null,
        mega = function(el){
            let megaBtn = el.find('.mega-dropdown-toggle'), megaMenu = el.find('.mega-dropdown-menu');
      ...
      menu
        .css({ 'margin-top': '-15px', opacity: 0 })
        .animate({ 'margin-top': '0px', opacity: 1 }, 250, function() {
                $(this).css({'margin-top':''});
        });
        },
        animOut = function(menu){
      menu
        .css({ 'margin-top': '0px', opacity: 1, display: 'block' })
        .animate({ 'margin-top': '15px', opacity: 0 }, 250, function() {
...
!(function($) {
    ...
    $(document).one('nifty.ready', () => {
        let niftyScrollTop = $('.scroll-top'), niftyWindow = $(window), isMobile = function(){
  ...
  var pageHolder,
    ...
    var defaults = {
      ...
      iconTemplate = function() {
        ...
        alertTimer,
      template = (function() {
            let clsBtn = opt.closeBtn ? '<button class="close" type="button"><i class="pci-cross pci-circle"></i></button>' : '';
        var defTemplate =
        ...
        opt.onHide();
          ...
          el
            .removeClass(opt.floating.animationIn)
      ...
      init = (function() {
          ...
          notyContainer = pageHolder;
            ...
            if (!niftyContainer || !niftyContentContainer.length)
...
!(function($) {
  ...
  $(document)
    .on('nifty.ready', bindForm)
    .on('change', '.form-checkbox, .form-radio', bindForm)
    .on('change', '.btn-file :file', function() {
      var input = $(this),
        ...
        size = (function() {
          ...
          return (
            (size / Math.pow(1024, rSize)).toFixed(2) * 1 +
            ' ' +
            ['B', 'kB', 'MB', 'GB', 'TB'][rSize]
          );
        })();
...
!(function($) {
    $(document).on('nifty.ready', () => {
        ...
        if (shortcutBtn.length) {
          ...
          template:
            '<div class="popover mainnav-shortcut"><div class="arrow"></div><div class="popover-content"></div>',
        });
            });
    } else {
            shortcutBtn = null;
  ...
  'use strict';
    ...
    niftyWindow = $(window),
        ...
        bindSmallNav = function(){
            let hidePopover, $menulink = $('#mainnav-menu > li > a, #mainnav-menu-wrap .mainnav-widget a[data-toggle="menu-widget"]');
        ...
        $el
          ...
          .on('shown.bs.popover', function() {
              ...
              return;
                    ...
                    let offsetTop 		= parseInt($popover.css('top')),
              ...
              if (
                !niftyContainer.hasClass('navbar-fixed') &&
                niftyMainNav.hasClass('affix-top')
              )
                offsetBottom -= 50;
    ...
    updateSize = function() {
      ...
      if (screenCat != currentScreen) {
        ...
        if (screenSize == 'sm' && niftyContainer.hasClass('mainnav-lg')) {
          ...
          screenSize == 'xs' &&
          niftyContainer.hasClass('mainnav-lg')
        ) {
          niftyContainer
          ...
          niftyContainer.hasClass('lg-mainnav-lg')
        ) {
      ...
      if (
        niftyContainer.hasClass('boxed-layout') &&
        niftyContainer.hasClass('mainnav-fixed') &&
        boxedContainer.length
      ) {
        niftyMainNav.css({
    ...
    init = function() {
      ...
      refresh: updateNav,
        ...
        var transitionNav = null;
                niftyMainNav.on('transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd', (e) => {
            if (transitionNav || e.target === niftyMainNav[0]) {
                        clearInterval(transitionNav);
                        transitionNav = setInterval(() => {
        ...
        // =================================================================
          ...
          if (scrollbar.length)
            scrollbar.nanoScroller({
              preventPageScrolling: niftyContainer.hasClass('mainnav-fixed')
                ? true
                : false,
            });
        } catch (err) {
    ...
    $.niftyNav = function(method,complete){
      ...
      if (
        ...
        if (screenSize == 'xs' && method == 'collapse') {
          ...
          niftyContainer.hasClass('mainnav-sm')
        ) {
          method = 'pushIn';
                }
            }
...
!(function($) {
  ...
  var niftyAside = null,
    ...
    updateAside = function() {
      ...
      if (
        niftyContainer.hasClass('boxed-layout') &&
        niftyContainer.hasClass('aside-fixed') &&
        boxedContainer.length
      ) {
        if (niftyContainer.hasClass('aside-left')) {
            ...
            transform:
              'translateX(' + (0 - boxedContainer.offset().left) + 'px)',
          };
        }
            }else{
                cssProp = {
        ...
        niftyWindow.on('resizeEnd', updateAside);
                niftyAside.on('transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd', (e) => {
        ...
        niftyAside
          .find('.nano')
          .nanoScroller({
            preventPageScrolling: niftyContainer.hasClass('aside-fixed')
              ? true
              : false,
          });
        ...
        if (toggleBtn.length) {
                ...
                $('html').on('click', (e) => {
          if (
            !$(e.target).closest('#aside-container').length &&
            niftyContainer.hasClass('aside-in')
          ) {
            $.niftyAside('hide');
...
!(function($) {
  ...
  var niftyMainNav,
    ...
    updateScroll = function(e) {
        ...
        updateScrollInterval = setInterval(() => {
            if(e[0] == niftyMainNav[0]){
                niftyMainnavScroll.nanoScroller({flash : true, preventPageScrolling: (!!niftyContainer.hasClass('mainnav-fixed'))});
          });
        } else if (e[0] == niftyAside[0]) {
                niftyAsideScroll.nanoScroller({preventPageScrolling: (!!niftyContainer.hasClass('aside-fixed'))});
            }
        }
        clearInterval(updateScrollInterval);
        updateScrollInterval = null;
    ...
    bindAffix = function() {
      ...
      if (niftyMainNav.length)
        niftyMainNav.niftyAffix({ className: 'mainnav-fixed' });
  ...
  $.fn.niftyAffix = function(method) {
    return this.each(function() {
      ...
      if (
        niftyContainer.hasClass(className) &&
        !niftyContainer.hasClass('navbar-fixed')
      ) {
        el
          .affix({
