...
!(function(a, b) {
  ...
  !(function(a) {
    ...
    function c(b) {
      ...
      let e,
        f = this.each(function() {
          const b = a(this);
          if (b.is('select')) {
            let f = b.data('selectpicker'),
              g = typeof d === 'object' && d;
            if (f) {
              if (g)
                for (const h in g) g.hasOwnProperty(h) && (f.options[h] = g[h]);
            } else {
              const i = a.extend(
                {},
                l.DEFAULTS,
            ...
            typeof d === 'string' &&
              (e = f[d] instanceof Function ? f[d](...c) : f.options[d]);
          }
        });
      return typeof e !== 'undefined' ? e : f;
    }
      ...
      !(function() {
        let a = {}.toString,
          ...
          d = function(b) {
            ...
            const d = String(this);
            if (b && a.call(b) == '[object RegExp]') throw new TypeError();
            let e = d.length,
              f = String(b),
              g = f.length,
              ...
              i = h ? Number(h) : 0;
            i != i && (i = 0);
            const j = Math.min(Math.max(i, 0), e);
      ...
      !(function() {
        let a = (function() {
          ...
          c = function(a) {
            if (this == null) throw new TypeError();
            const c = String(this);
            if (a && b.call(a) == '[object RegExp]') throw new TypeError();
            let d = c.length,
              e = String(a),
              f = e.length,
              ...
              h = g ? Number(g) : 0;
            h != h && (h = 0);
            const i = Math.min(Math.max(h, 0), d);
            if (f + i > d) return !1;
            for (let j = -1; ++j < f; )
    ...
    const d = { useDefault: !1, _set: a.valHooks.select.set };
    ...
    var g = {
      ...
      l = function(b, c) {
        d.useDefault ||
          (
            (a.valHooks.select.set = d._set),
            (d.useDefault = !0)
          ), (this.$element = a(
          b,
        )), (this.$newElement = null), (this.$button = null), (this.$menu = null), (this.$lis = null), (this.options = c), this
          .options.title === null &&
          (this.options.title = this.$element.attr('title'));
        const e = this.options.windowPadding;
        typeof e === 'number' &&
          (this.options.windowPadding = [e, e, e, e]), (this.val =
          l.prototype.val), (this.render = l.prototype.render), (this.refresh =
          l.prototype.refresh), (this.setStyle =
          l.prototype.setStyle), (this.selectAll =
          l.prototype.selectAll), (this.deselectAll =
          l.prototype.deselectAll), (this.destroy =
          l.prototype.destroy), (this.remove = l.prototype.remove), (this.show =
          l.prototype.show), (this.hide = l.prototype.hide), this.init();
      };
    (l.VERSION = '1.12.4'), (l.DEFAULTS = {
      noneSelectedText: 'Nothing selected',
      noneResultsText: 'No results matched {0}',
      countSelectedText(a, b) {
        return a == 1 ? '{0} item selected' : '{0} items selected';
      },
      maxOptionsText(a, b) {
        return [
          a == 1
      ...
      init() {
        ...
        this.$element.addClass(
          ...
          'input',
        )), this.$element.removeClass('bs-select-hidden'), this.options
          .dropdownAlignRight === !0 &&
          this.$menu.addClass('dropdown-menu-right'), typeof c !==
          'undefined' &&
          (
            this.$button.attr('data-id', c),
            a(`label[for="${c}"]`).click(a => {
      ...
      createDropdown() {
        let b = this.multiple || this.options.showTick ? ' show-tick' : '',
          c = this.$element.parent().hasClass('input-group')
            ? ' input-group-btn'
            : '',
          d = this.autofocus ? ' autofocus' : '',
          e = this.options.header
            ? `<div class="popover-title"><button type="button" class="close" aria-hidden="true">&times;</button>${this
                .options.header}</div>`
            : '',
          f = this.options.liveSearch
            ? `<div class="bs-searchbox"><input type="text" class="form-control" autocomplete="off"${this
                .options.liveSearchPlaceholder === null
                ? ''
                : ` placeholder="${j(
          ...
          g =
            this.multiple && this.options.actionsBox
              ? `<div class="bs-actionsbox"><div class="btn-group btn-group-sm btn-block"><button type="button" class="actions-btn bs-select-all btn btn-default">${this
                  .options
                  .selectAllText}</button><button type="button" class="actions-btn bs-deselect-all btn btn-default">${this
                  .options.deselectAllText}</button></div></div>`
              : '',
          h =
            this.multiple && this.options.doneButton
              ? `<div class="bs-donebutton"><div class="btn-group btn-block"><button type="button" class="btn btn-sm btn-default">${this
                  .options.doneButtonText}</button></div></div>`
              : '',
          i = `<div class="btn-group bootstrap-select${b}${c}"><button type="button" class="${this
            .options
            .styleBase} dropdown-toggle" data-toggle="dropdown"${d} role="button"><span class="filter-option pull-left"></span>&nbsp;<span class="bs-caret">${this
            .options.template
      ...
      createView() {
        let a = this.createDropdown(),
          b = this.createLi();
        return (a.find('ul')[0].innerHTML = b), a;
      },
      reloadLi() {
        const a = this.createLi();
      ...
      createLi() {
        let c = this,
          ...
          g = -1,
          h = function(a, b, c, d) {
            return `<li${typeof c !== 'undefined' && c !== ''
              ? ` class="${c}"`
          ...
          i = function(d, e, f, g) {
            return `<a tabindex="0"${typeof e !== 'undefined'
              ? ` class="${e}"`
              : ''}${f ? ` style="${f}"` : ''}${c.options.liveSearchNormalize
              ? ` data-normalized-text="${b(j(a(d).html()))}"`
              : ''}${typeof g !== 'undefined' || g !== null
              ? ` data-tokens="${g}"`
              : ''} role="option">${d}<span class="${c.options.iconBase} ${c
              .options.tickIcon} check-mark"></span></a>`;
          };
        if (
          this.options.title &&
          !this.multiple &&
          ...
          const k = this.$element[0];
          (f.className =
            'bs-title-option'), (f.innerHTML = this.options.title), (f.value =
            ''), k.insertBefore(f, k.firstChild);
          const l = a(k.options[k.selectedIndex]);
          void 0 === l.attr('selected') &&
            void 0 === this.$element.data('selected') &&
            (f.selected = !0);
        }
        const m = this.$element.find('option');
        return m.each(function(b) {
          ...
          if ((g++, !f.hasClass('bs-title-option'))) {
            let k,
              ...
              q =
                typeof f.data('subtext') !== 'undefined'
                  ? `<small class="text-muted">${f.data('subtext')}</small>`
                  : '',
              r =
                typeof f.data('icon') !== 'undefined'
                  ? `<span class="${c.options.iconBase} ${f.data(
                      'icon',
                    )}"></span> `
                  : '',
              s = f.parent(),
              t = s[0].tagName === 'OPTGROUP',
              u = t && s[0].disabled,
              v = this.disabled || u;
            if (
              (
            ...
            if (
              ...
              const x = ` ${s[0].className}` || '';
              if (f.index() === 0) {
                e += 1;
                let y = s[0].label,
                  z =
                    typeof s.data('subtext') !== 'undefined'
                      ? `<small class="text-muted">${s.data('subtext')}</small>`
                      : '',
                  A = s.data('icon')
                    ? `<span class="${c.options.iconBase} ${s.data(
                        'icon',
                      )}"></span> `
                    : '';
                (y = `${A}<span class="text">${j(y)}${z}</span>`), b !== 0 &&
                  d.length > 0 &&
              ...
              if (
                ...
                const C = m.eq(k)[0].previousElementSibling;
                C && C.tagName === 'OPTGROUP' && !C.disabled && (B = !0);
              }
      ...
      findLis() {
        return this.$lis == null && (this.$lis = this.$menu.find('li')), this
          .$lis;
      },
      render(b) {
        let c,
        ...
        b !== !1 &&
          e.each(function(a) {
            const b = d.findLis().eq(d.liObj[a]);
            d.setDisabled(
              a,
              this.disabled ||
                ...
                let b,
                  ...
                  e =
                    c.data('icon') && d.options.showIcon
                      ? `<i class="${d.options.iconBase} ${c.data(
                          'icon',
                        )}"></i> `
                      : '';
                return (b =
        ...
        if (
          ...
          const h = this.options.selectedTextFormat.split('>');
          if (
            (h.length > 1 && f.length > h[1]) ||
            (h.length == 1 && f.length >= 2)
          ) {
            c = this.options.hideDisabled ? ', [disabled]' : '';
            let i = e.not(`[data-divider="true"], [data-hidden="true"]${c}`)
                .length,
              j =
        ...
        void 0 == this.options.title &&
          (this.options.title = this.$element.attr('title')), this.options
          .selectedTextFormat == 'static' && (g = this.options.title), g ||
          (g =
      ...
      liHeight(b) {
        if (b || (this.options.size !== !1 && !this.sizeInfo)) {
          ...
          if (
            ...
            (k.className = 'bs-searchbox'), (n.className =
              'form-control'), k.appendChild(n), d.appendChild(k);
          }
          l && d.appendChild(l), d.appendChild(e), m &&
            d.appendChild(m), c.appendChild(d), document.body.appendChild(c);
          let o = h.offsetHeight,
            p = j ? j.offsetHeight : 0,
            q = k ? k.offsetHeight : 0,
            r = l ? l.offsetHeight : 0,
            s = m ? m.offsetHeight : 0,
            t = a(f).outerHeight(!0),
            u = typeof getComputedStyle === 'function' && getComputedStyle(d),
            v = u ? null : a(d),
            w = {
              vert:
          ...
          let b,
            ...
            y = function() {
              ...
              j.options.container && !d.is('body')
                ...
                : (b = { top: 0, left: 0 });
              const e = j.options.windowPadding;
              (f = c.top - b.top - m.scrollTop()), (g =
                m.height() - f - n - b.top - e[2]), (h =
                c.left - b.left - m.scrollLeft()), (i =
                m.width() - h - o - b.left - e[1]), (f -= e[0]), (h -= e[3]);
            };
          if ((y(), this.options.size === 'auto')) {
            const z = function() {
              let m,
                n = function(b, c) {
                  return function(d) {
              ...
              y(), (b = g - w.vert), (c = i - w.horiz), j.options.container
                ...
                j.$newElement.toggleClass(
                  'dropup',
                  f > g && b - w.vert < d,
                ), j.$newElement.hasClass('dropup') && (b = f - w.vert), j
                .options.dropdownAlignRight === 'auto' &&
                k.toggleClass(
                  'dropdown-menu-right',
                  h > i && c - w.horiz < e - o,
                ), (m =
                x.length + z.length > 3 ? 3 * p + w.vert - 2 : 0), k.css({
                'max-height': `${b}px`,
                overflow: 'hidden',
      ...
      setWidth() {
        if (this.options.width === 'auto') {
          ...
          let a = this.$menu.parent().clone().appendTo('body'),
      ...
      checkDisabled() {
        ...
        this.isDisabled()
          ...
          : (
            ...
            ), this.$button.click(() => !a.isDisabled());
      },
      togglePlaceholder() {
        const a = this.$element.val();
        this.$button.toggleClass(
          'bs-placeholder',
          a === null || a === '' || (a.constructor === Array && a.length === 0),
        );
      },
      tabIndex() {
      ...
      clickListener() {
        let b = this,
          c = a(document);
        c.data('spaceSelect', !1), this.$button.on('keyup', a => {
          ...
          if (b.options.liveSearch || b.multiple) {
            if (!b.multiple) {
              const a = b.liObj[b.$element[0].selectedIndex];
              if (typeof a !== 'number' || b.options.size === !1) return;
              let c = b.$lis.eq(a)[0].offsetTop - b.$menuInner[0].offsetTop;
              (c =
                c -
          ...
          if (
            (
              b.multiple && b.options.maxOptions !== 1 && c.stopPropagation(),
              c.preventDefault(),
              !b.isDisabled() && !d.parent().hasClass('disabled')
            )
          ) {
            let j = b.$element.find('option'),
              k = j.eq(f),
              l = k.prop('selected'),
              m = k.parent('optgroup'),
            ...
            if (b.multiple) {
              if (
                ...
                let p = n < j.filter(':selected').length,
                ...
                if ((n && p) || (o && q))
                  if (n && n == 1)
                    ...
                    const r = d.parent().data('optgroup');
                    b.$menuInner
                      .find(`[data-optgroup="${r}"]`)
                      .removeClass('selected'), b.setSelected(f, !0);
                  } else {
                    let s =
                        typeof b.options.maxOptionsText === 'string'
                          ? [b.options.maxOptionsText, b.options.maxOptionsText]
                          : b.options.maxOptionsText,
                      t = typeof s === 'function' ? s(n, o) : s,
                      u = t[0].replace('{n}', n),
                      v = t[1].replace('{n}', o),
                    ...
                    t[2] &&
                      ...
                      ), k.prop('selected', !1), b.$menu.append(w), n &&
                      p &&
                      (
            ...
            !b.multiple || (b.multiple && b.options.maxOptions === 1)
              ? b.$button.focus()
      ...
      liveSearchListener() {
        ...
        this.$button.on('click.dropdown.data-api', () => {
          c.$menuInner
            .find('.active')
            .removeClass('active'), c.$searchbox.val() &&
            (
              c.$searchbox.val(''),
          ...
          if (
            ...
            if (
              ...
              ), c.$menuInner.append(d), c.$lis.addClass('hidden');
            else {
              e.addClass('hidden');
              let g,
                h = c.$lis.not('.hidden');
      ...
      _searchStyle() {
        const a = { begins: 'ibegins', startsWith: 'ibegins' };
      ...
      changeAll(b) {
        if (this.multiple) {
          typeof b === 'undefined' && (b = !0), this.findLis();
          let c = this.$element.find('option'),
            d = this.$lis.not('.divider, .dropdown-header, .disabled, .hidden'),
            e = d.length,
            f = [];
          if (b) {
            if (d.filter('.selected').length === d.length) return;
          } else if (d.filter('.selected').length === 0) return;
          d.toggleClass('selected', b);
          for (let g = 0; g < e; g++) {
            const h = d[g].getAttribute('data-original-index');
            f[f.length] = c.eq(h)[0];
          }
      ...
      keydown(b) {
        ...
        if (
          ...
          (d = i.options.liveSearch
            ...
            : c.index(
                c.find('a').filter(':focus').parent(),
              )), (e = i.$menuInner.data('prevIndex')), b.keyCode == 38
            ? (
            ...
            : b.keyCode == 40 &&
              (
                ...
                (d %= c.length)
              ), i.$menuInner.data('prevIndex', d), i.options.liveSearch
            ? (
                b.preventDefault(),
          ...
          (c = i.$lis.filter(j)), c.each(function(c) {
            ...
            : l >= n.length &&
              (a(document).data('keycount', 0), l > n.length && (l = 1)), c
            .eq(n[l - 1])
            .children('a')
            .focus();
        }
