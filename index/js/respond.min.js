    ...
    var g,
      ...
      t = function() {
        ...
        return (b.style.cssText =
          'position:absolute;font-size:1em;width:1em'), c ||
          (
            (c = f = j.createElement('body')),
            (c.style.background = 'none')
          ), (k.style.fontSize = '100%'), (c.style.fontSize =
          '100%'), c.appendChild(b), f && k.insertBefore(c, k.firstChild), (a =
          b.offsetWidth), f
          ? k.removeChild(c)
      ...
      v = function(a, b, d) {
        let e = a.replace(c.regex.keyframes, '').match(c.regex.media),
          f = (e && e.length) || 0;
