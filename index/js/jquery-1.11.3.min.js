...
!(function(a, b) {
  ...
  (m.fn = m.prototype = {
    ...
    for (
      typeof g == 'boolean' &&
        ((j = g), (g = arguments[h] || {}), h++), typeof g == 'object' ||
        m.isFunction(g) ||
        (g = {}), h === i && ((g = this), h--);
      i > h;
      h++
  ...
  let s = (function(a) {
    ...
    function qa() {}
    (qa.prototype = d.filters =
      d.pseudos), (d.setFilters = new qa()), (g = ga.tokenize = function(a, b) {
      let c,
        e,
        f,
        g,
    ...
    return (h = ga.compile = function(a, b) {
      ...
      u.split('').sort(B).join('') ===
      u), (c.detectDuplicates = !!l), m(), (c.sortDetached = ja((a) => {
  ...
  let x,
    ...
    A = (m.fn.init = function(a, b) {
      ...
      return a.nodeType
        ...
        : m.isFunction(a)
          ? typeof x.ready != 'undefined' ? x.ready(a) : a(m)
          : (
              void 0 !== a.selector &&
    ...
    if (m.acceptData(a)) {
      ...
      if (
        ...
        return k || (k = i ? (a[h] = c.pop() || m.guid++) : h), j[k] ||
          (j[k] = i ? {} : { toJSON: m.noop }), (typeof b == 'object' ||
          typeof b == 'function') &&
          (e
            ? (j[k] = m.extend(j[k], b))
            : (j[k].data = m.extend(j[k].data, b))), (g = j[k]), e ||
          (g.data || (g.data = {}), (g = g.data)), void 0 !== d &&
          (g[m.camelCase(b)] = d), typeof b == 'string'
  ...
  let S = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
    ...
    U = function(a, b) {
      return (a = b || a), m.css(a, 'display') === 'none' ||
      ...
      (
        ...
        (Ja = function(a, b, c) {
          let d,
            ...
            g,
            h = a.style;
          return (c = c || Ia(a)), (g = c ? c[b] : void 0), g == null &&
            h &&
            h[b] &&
            (g = h[b]), Ha.test(g) &&
            !Ka.test(b) &&
  ...
  !(function() {
    ...
    if (
      ...
      (c.cssText = 'float:left;opacity:.5'), (k.opacity =
        c.opacity ===
        '0.5'), (k.cssFloat = !!c.cssFloat), (b.style.backgroundClip =
        'content-box'), (b.cloneNode(!0).style.backgroundClip =
        ''), (k.clearCloneStyle =
        b.style.backgroundClip === 'content-box'), (k.boxSizing =
        c.boxSizing === '' ||
        c.MozBoxSizing === '' ||
  ...
  function Xa(a, b, c, d, e) {
    for (
      ...
      c === 'margin' && (g += m.css(a, c + T[f], !0, e)), d
        ? (
  ...
  function Ya(a, b, c) {
    let d = !0,
      ...
      f = Ia(a),
      g = k.boxSizing && m.css(a, 'boxSizing', !1, f) === 'border-box';
    if (e <= 0 || e == null) {
      if (
        (
          (e = Ja(a, b, f)),
  ...
  m.extend({
    ...
    }), (m.cssHooks.marginRight = La(k.reliableMarginRight, (a, b) => {
    return b
  ...
  function ib(a, b, c) {
    ...
    if (m.isEmptyObject(o))
      ('none' === j ? Fa(a.nodeName) : j) === 'inline' && (p.display = j);
    else {
  ...
  (m.Animation = m.extend(kb, {
    ...
    return (d.duration = m.fx.off
      ...
      : typeof d.duration == 'number'
        ...
        : d.duration in m.fx.speeds
          ...
          : m.fx.speeds._default), (d.queue == null || d.queue === !0) &&
    ...
    return (a = m.fx ? m.fx.speeds[a] || a : a), (b =
      b || 'fx'), this.queue(b, (b, c) => {
      let d = setTimeout(b, a);
      c.stop = function() {
        clearTimeout(d);
      };
    });
  ...
  let sb = /^(?:input|select|textarea|button|object)$/i,
    tb = /^(?:a|area)$/i;
  m.fn.extend({
    prop(a, b) {
  ...
  (m.parseJSON = function(b) {
    ...
    return e &&
    !m.trim(
      e.replace(xb, (a, b, e, f) => {
        return c &&
          b &&
          (d = 0), d === 0 ? a : ((c = e || b), (d += !f - !e), '');
      }),
    )
      ? Function(`return ${  e}`)()
  ...
  (m.param = function(a, b) {
    let c,
      d = [],
      e = function(a, b) {
        (b = m.isFunction(b) ? b() : b == null ? '' : b), (d[d.length] =
    ...
    return h || b.dataTypes[0] === 'jsonp'
      ? (
          ...
          d.always(() => {
            (a[
              e
            ] = f), b[e] && ((b.jsonpCallback = c.jsonpCallback), _b.push(e)), g && m.isFunction(f) && f(g[0]), (g = f = void 0);
          }),
          'script'
        )
      : void 0;
  ...
  (m.fn.load = function(a, b, c) {
    ...
    return h >= 0 &&
      ...
      ? ((c = b), (b = void 0))
      : b && typeof b == 'object' && (f = 'POST'), g.length > 0 &&
      m
  ...
  let cc = a.document.documentElement;
  function dc(a) {
    return m.isWindow(a)
      ? a
  ...
  (m.offset = {
    ...
    m.cssHooks[b] = La(k.pixelPosition, (a, c) => {
      return c
    ...
    return this.length;
  }), (m.fn.andSelf = m.fn.addBack), typeof define == 'function' &&
    define.amd &&
    define('jquery', [], () => {
      return m;
    });
