...
jQuery.migrateMute === void 0 && (jQuery.migrateMute = !0), (function(e, t, n) {
  ...
  (e.migrateWarnings = []), !e.migrateMute &&
    t.console &&
    t.console.log &&
    t.console.log('JQMIGRATE: Logging is active'), e.migrateTrace === n &&
    (e.migrateTrace = !0), (e.migrateReset = function() {
    (i = {}), (e.migrateWarnings.length = 0);
  }), document.compatMode === 'BackCompat' &&
    r('jQuery is not compatible with Quirks Mode');
  let o = e('<input/>', { size: 1 }).attr('size') && e.attrFn,
    s = e.attr,
    u =
      ...
      : (
          ...
          !e.attrHooks[c] &&
            ...
            (
              ...
              f.test(c) &&
                r(
                  `jQuery.fn.attr('${c}') may use property instead of attribute`,
                )
            ),
          s.call(e, t, a, i)
        );
  ...
  (e.fn.init = function(t, n, a) {
    ...
    e.extend(
      ...
      t,
      this,
    ), (t.superclass = this), (t.fn = t.prototype = this()), (t.fn.constructor = t), (t.sub = this.sub), (t.fn.init = function(
      r,
      a,
    ) {
      return a &&
        a instanceof e &&
        !(a instanceof t) &&
        (a = t(a)), e.fn.init.call(this, r, a, n);
  ...
  (e.fn.andSelf = function() {
    ...
    (e.clean = function(t, a, i, o) {
      (a = a || document), (a = (!a.nodeType && a[0]) || a), (a =
        a.ownerDocument || a), r('jQuery.clean() is deprecated');
      let s,
        u,
        c,
        l,
  ...
  let Q = e.event.add,
    ...
    H = /(?:^|\s)hover(\.\S+|)\b/,
    A = function(t) {
      return typeof t !== 'string' || e.event.special.hover
        ? t
        : (
            H.test(t) &&
              r(
  ...
  e.event.props &&
    ...
    e !== document &&
      C.test(t) &&
      r(`AJAX events should be attached to document: ${t}`), Q.call(
      this,
      e,
      A(t || ''),
      n,
    ...
    return r('jQuery.fn.error() is deprecated'), e.splice(
      0,
      0,
      'error',
    ), arguments.length
    ...
    let a = arguments,
      ...
      o = 0,
      s = function(n) {
        const r = (e._data(this, `lastToggle${t.guid}`) || 0) % o;
        return e._data(
          this,
          `lastToggle${t.guid}`,
          r + 1,
