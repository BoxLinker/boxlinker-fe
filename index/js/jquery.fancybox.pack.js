...
(function(r, G, f, v) {
  ...
  f.extend(b, {
    ...
    defaults: {
      ...
      tpl: {
        ...
        iframe: `<iframe id="fancybox-frame{rnd}" name="fancybox-frame{rnd}" class="fancybox-iframe" frameborder="0" vspace="0" hspace="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen${I
    ...
    bindEvents() {
      ...
      a &&
        (
          n.bind(
            `orientationchange.fb${s ? '' : ' resize.fb'}${a.autoCenter &&
            !a.locked
              ? ' scroll.fb'
              : ''}`,
            b.update,
              ...
              for (
                ...
                (j =
                  ...
                  ((h[0].clientWidth && h[0].scrollWidth > h[0].clientWidth) ||
                    (h[0].clientHeight &&
                      h[0].scrollHeight > h[0].clientHeight))), (h = f(
                  h,
                ).parent());
    ...
    _start(a) {
      ...
      if (!1 === b.trigger('beforeLoad')) b.coming = null;
        ...
        e = d.href;
        if (!c)
          return (b.coming = null), b.current &&
          b.router &&
          b.router !== 'jumpto'
        ...
        d.wrap = f(d.tpl.wrap)
          .addClass(
            `fancybox-${s
              ? 'mobile'
              : 'desktop'} fancybox-type-${c} fancybox-tmp ${d.wrapCSS}`,
          )
        ...
        if (!1 === b.trigger('afterLoad', a, d))
          ...
          switch (c) {
            ...
            case 'image':
              ...
              break;
            case 'swf':
              (e = `<object id="fancybox-swf" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="100%" height="100%"><param name="movie" value="${g}"></param>`), (h =
                ''), f.each(a.swf, (a, b) => {
    ...
    _setDimension() {
      ...
      if (h.type === 'iframe') {
        if (((H = h.content), h.autoHeight && H.data('ready') === 1))
          try {
        ...
        g.addClass('fancybox-tmp'), h.autoWidth || g.width(C), h.autoHeight ||
          g.height(A), h.autoWidth && (C = g.width()), h.autoHeight &&
      ...
      if (h.fitToView)
        if (
          ...
          for (; (a > z || y > r) && (c > m && j > u) && !(d++ > 19); )
            (j = Math.max(u, Math.min(p, j - 10))), (c = l(j * D)), c < m &&
              ((c = m), (j = l(c / D))), c > n &&
              ((c = n), (j = l(c / D))), g.width(c).height(j), e.width(
              c + x,
            ), (a = e.width()), (y = e.height());
        else
          (c = Math.max(m, Math.min(c, c - (a - z)))), (j = Math.max(
            u,
            Math.min(j, j - (y - r)),
          ));
      q && (s === 'auto' && j < A && c + x + q < z) && (c += q);
      g.width(c).height(j);
      e.width(c + x);
      a = e.width();
      y = e.height();
    ...
    _afterZoomIn() {
      ...
      a &&
        (
          ...
          a.closeBtn &&
            f(a.tpl.closeBtn).appendTo(b.skin).bind('click.fb', a => {
              a.preventDefault();
              b.close();
            }),
          a.arrows &&
    ...
    step(a, d) {
      ...
      if (f === 'width' || f === 'height')
        (e =
          d.end === d.start
            ? 1
            : (a - d.start) / (d.end - d.start)), b.isClosing &&
          (e = 1 - e), (c = f === 'width' ? c.wPadding : c.hPadding), (c =
          a - c), b.skin[f](l(f === 'width' ? c : c - g * e)), b.inner[f](
          l(f === 'width' ? c : c - g * e - h * e),
        );
    },
    zoomIn() {
      let a = b.current,
      ...
      if (q(e) && f.trim(e) !== '') {
        ...
        switch (c) {
          ...
          case 'over':
            ...
            break;
          default:
            (c = b.skin), d.appendTo('body'), I &&
              d.width(d.width()), d.wrapInner(
  ...
  p.ready(() => {
    ...
    f(
      `<style type='text/css'>.fancybox-margin{margin-right:${d -
        a}px;}</style>`,
    ).appendTo('head');
  });
