(function() {
  ...
  result = function() {
    let args, key, obj;
    (obj = arguments[0]), (key = arguments[1]), (args =
      arguments.length >= 3 ? __slice.call(arguments, 2) : []);
  ...
  Evented = (function() {
    ...
    Evented.prototype.trigger = function() {
      ...
      if ((_ref = this.bindings) != null ? _ref[event] : void 0) {
        ...
        _results = [];
        while (i < this.bindings[event].length) {
          (_ref1 = this.bindings[event][i]), (handler = _ref1.handler), (ctx =
            _ref1.ctx), (once = _ref1.once);
  ...
  XHRRequestTracker = (function() {
    function XHRRequestTracker(request) {
      ...
      if (window.ProgressEvent != null) {
        ...
        for (_j = 0, _len1 = _ref2.length; _j < _len1; _j++) {
          event = _ref2[_j];
          request.addEventListener(event, () => (_this.progress = 100), false);
        }
      } else {
